 ...
 */
public class UsersAdapter_Broadcast extends RecyclerView.Adapter<UsersAdapter_Broadcast.MyViewHolder> {
    Boolean flag = false;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            try {
                ...
                Picasso.with(ctx.getApplicationContext()).load("http://www.bjain.com/doctor/upload/" + PreferenceData.getPhoto(ctx.getApplicationContext())).into(img_profile);
            } catch (Exception e) {
    ...
    public UsersAdapter_Broadcast(List<InfoApps> moviesList, Context ctx) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Log.e("c_da",UtilsValidate.getCurrentDate().toString());
        if (UtilsValidate.getCurrentDate().equals(movie.getNumber())) {
