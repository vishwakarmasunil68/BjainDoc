 ...
 */
public class BroadNote_view1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.broadnote);
...
//         mSnackBarLayout = (CoordinatorLayout) findViewById(R.id.coordinator_layout);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(BroadNote_view1.this);
    ...
    public class CallServices extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(BroadNote_view1.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            namevaluepair.add(new BasicNameValuePair("p_note_id", PreferenceData.getPatientId(getApplicationContext())));
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
						...
						Detailapp.setStatus(patient_status);*/
                            ...
                            mAdapterbroad = new UsersAdapter_Broadnote(contactDetails1, BroadNote_view1.this);
                            mRecyclerView.setAdapter(mAdapterbroad);
                        }
                        else {
                            Toast.makeText(BroadNote_view1.this,"Sorry no notification for you", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    }
                } catch (Exception e) {
