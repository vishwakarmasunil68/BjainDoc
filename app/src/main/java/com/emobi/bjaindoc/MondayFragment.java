...
public class MondayFragment extends Fragment implements View.OnClickListener{
    ...
    public static String appointment_time,appointment_date;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*Date dt = new Date("09:00:AM");
        SimpleDateFormat sdf = new SimpleDateFormat("hh:mm aa");
        String time1 = sdf.format(dt);
        Date dt1 = new Date("11:00:AM");
        ...
        String string1 = "09:00 AM";

        try {
//            SimpleDateFormat df = new SimpleDateFormat("hh:mm aa");

//            SimpleDateFormat df = new SimpleDateFormat("hh:aa");
            SimpleDateFormat df = new SimpleDateFormat("HH:mm");
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time1_morn);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time1_morn);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sd2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sd2.format(c2.getTime());
            String startTime1 = UsersAdapter_Serach_Doc.avl_start_time1_morn;
            String endtime1 = UsersAdapter_Serach_Doc.avl_end_time1_morn;
            ...
            Date date= null;
            try {
                            date = readFormat.parse(startTime1);
                            date1 = readFormat.parse(endtime1);
                        } catch (ParseException e) {
                            e.printStackTrace();
                        }

                        if (date != null) {
                            String formattedDatefrom = writeFormat.format(date);
                            String formattedDateto = writeFormat.format(date1);
                            getTime(formattedDatefrom,formattedDateto);
                            Log.e("formateddates",formattedDatefrom);
                            Log.e("formattedDateto",formattedDateto);
                        }
        ...
        try {
            SimpleDateFormat df = new SimpleDateFormat("HH:mm");
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time1_afternoon);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time1_afternoon);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sdf2.format(c2.getTime());

            getTimeaftr(UsersAdapter_Serach_Doc.avl_start_time1_afternoon, UsersAdapter_Serach_Doc.avl_end_time1_afternoon);
            Log.e("c1.getTime()",str1 + " "+ st2);
        }
        catch (Exception e){
            e.printStackTrace();
            Log.e("c1.getTime()","getTime()");
        }

        try {
            SimpleDateFormat df = new SimpleDateFormat("HH:mm");
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time1_even);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time1_even);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sdf2.format(c2.getTime());
            String startTime1 = UsersAdapter_Serach_Doc.avl_start_time1_even;
            String endtime1 = UsersAdapter_Serach_Doc.avl_end_time1_even;
            ...
            if (date != null) {
                String formattedDatefrom = writeFormat.format(date);
                String formattedDateto = writeFormat.format(date1);
                getTimeeven(formattedDatefrom,formattedDateto);
                Log.e("formateddates",formattedDatefrom);
                Log.e("formattedDateto",formattedDateto);
            }
//            getTimeeven(UsersAdapter_Serach_Doc.avl_start_time1_even,UsersAdapter_Serach_Doc.avl_end_time1_even);
            Log.e("c1.getTime()",str1 + " "+ st2);
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.sixam:
                ...
                appointment_date=UtilsValidate.getCurrentDate();
                monday=true;
            ...
            if (result != null) {
                ...
                try {
                    ...
                    for (int i=0; i<jsonArray.length();i++) {
                        ...
                        String cudtae = UtilsgetCurrentDate.getCurrentDate();
