...
public class Database {
    ...
    public long insertStoredUrgentChat(NewUrgentChatResultPOJO dep){
//        //Log.d("sunil","insert:-"+dep.toString());
        ...
        contentValues.put(DataBaseHelper.u_chat_date, dep.getU_chat_date()+"");
        contentValues.put(DataBaseHelper.u_chat_time, dep.getU_chat_time()+"");
        ...
        contentValues.put(DataBaseHelper.u_thumb_file, dep.getU_thumb_file()+"");
        contentValues.put(DataBaseHelper.u_message_type, dep.getU_message_type()+"");
    ...
    public List<NewUrgentChatResultPOJO> getAllStoredUrgentChat(){
        SQLiteDatabase db=helper.getWritableDatabase();
        List<NewUrgentChatResultPOJO> lst=new ArrayList<>();
        String[] columns={DataBaseHelper.ID,
                DataBaseHelper.u_chat_id,
                DataBaseHelper.u_chat_p_id,
                DataBaseHelper.u_chat_doc_id,
                DataBaseHelper.u_chat_date,
                DataBaseHelper.u_chat_time,
                DataBaseHelper.u_chat_msg,
                DataBaseHelper.u_chat_title,
                DataBaseHelper.u_chat_file,
                DataBaseHelper.u_thumb_file,
                DataBaseHelper.u_message_type,
...
//
            NewUrgentChatResultPOJO newUrgentChatResultPOJO=
                    new NewUrgentChatResultPOJO(cursor.getString(1),
                            cursor.getString(2),
                            cursor.getString(3),
                            cursor.getString(4),
                            cursor.getString(5),
    ...
    public List<NewUrgentChatResultPOJO> getStoredUrgentChatByPID(String p_id){
        SQLiteDatabase db=helper.getWritableDatabase();
        List<NewUrgentChatResultPOJO> lst=new ArrayList<>();
        String[] columns={DataBaseHelper.ID,
                DataBaseHelper.u_chat_id,
...
//    }
    ...
    public long insertServerUrgentChat(NewUrgentChatResultPOJO dep){
//        //Log.d("sunil","insert:-"+dep.toString());
        SQLiteDatabase db=helper.getWritableDatabase();
        ContentValues contentValues=new ContentValues();
    ...
    public List<NewUrgentChatResultPOJO> getAllSERVERUrgentChat(){
        SQLiteDatabase db=helper.getWritableDatabase();
        List<NewUrgentChatResultPOJO> lst=new ArrayList<>();
        String[] columns={DataBaseHelper.ID,
                DataBaseHelper.u_chat_id,
...
//            String u_direction=cursor.getString(9);
    ...
    public List<NewUrgentChatResultPOJO> getSERVERUrgentChatByPID(String p_id){
        SQLiteDatabase db=helper.getWritableDatabase();
        List<NewUrgentChatResultPOJO> lst=new ArrayList<>();
        String[] columns={DataBaseHelper.ID,
                DataBaseHelper.u_chat_id,
...
//    }
    ...
    static class DataBaseHelper extends SQLiteOpenHelper {
        ...
        private static final String u_chat_date="u_chat_date";
        private static final String u_chat_time="u_chat_time";
        ...
        private static final String u_thumb_file="u_thumb_file";
        private static final String u_message_type="u_message_type";
        ...
        private static final String CREATE_STORE_TABLE="CREATE TABLE "+STORED_URGENT_CHAT_TABLE+" ("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "
                ...
                +u_chat_date +" VARCHAR(255), "
                +u_chat_time+" VARCHAR(255), "
                +u_chat_msg+" VARCHAR(255), "
                +u_chat_title+" VARCHAR(255), "
                +u_chat_file+" VARCHAR(255),  "
                +u_thumb_file+" VARCHAR(255),  "
                +u_message_type+" VARCHAR(255),  "
