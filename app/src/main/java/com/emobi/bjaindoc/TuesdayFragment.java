...
public class TuesdayFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time2_morn);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time2_morn);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sd2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sd2.format(c2.getTime());
            getTime(UsersAdapter_Serach_Doc.avl_start_time2_morn, UsersAdapter_Serach_Doc.avl_end_time2_morn);
        ...
        try {
            SimpleDateFormat df = new SimpleDateFormat("hhaa");
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time2_afternoon);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time2_afternoon);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sdf2.format(c2.getTime());
            getTimeaftr(UsersAdapter_Serach_Doc.avl_start_time2_afternoon, UsersAdapter_Serach_Doc.avl_end_time2_afternoon);
            Log.e("c1.getTime()", str1 + st2);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            SimpleDateFormat df = new SimpleDateFormat("hhaa");
            Date d1 = df.parse(UsersAdapter_Serach_Doc.avl_start_time2_even);
            Calendar c1 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
            c1.setTime(d1);
            String str1 = sdf.format(c1.getTime());

            Date d2 = df.parse(UsersAdapter_Serach_Doc.avl_end_time2_even);
            Calendar c2 = GregorianCalendar.getInstance();
            SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss");
            c2.setTime(d2);
            String st2 = sdf2.format(c2.getTime());
            getTimeeven(UsersAdapter_Serach_Doc.avl_start_time2_even, UsersAdapter_Serach_Doc.avl_end_time2_even);
            Log.e("c1.getTime()", str1 + st2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.sixam:
                ...
                appointment_date = UtilsgetCurrentDate.getTomorrowDate();
                tuesday = true;
            ...
            if (result != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        Log.e("jsonArray", jsonArray.toString());
                        JSONObject jsonObject = jsonArray.getJSONObject(i);
                        String cudtae = UtilsgetCurrentDate.getTomorrowDate();
