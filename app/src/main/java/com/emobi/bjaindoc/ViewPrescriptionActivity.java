...
//         mSnackBarLayout = (CoordinatorLayout) findViewById(R.id.coordinator_layout);
        ...
        new CallServices().execute(ApiConfig.doctorprescription);
...
//        });
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ViewPrescriptionActivity.this,AddPatientActivity.class));
                finish();
            }
        });
    }
    ...
    public class CallServices extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(ViewPrescriptionActivity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            namevaluepair.add(new BasicNameValuePair("pre_doc_id", PreferenceData.getId(getApplicationContext())));
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (message.equals("Not Book any Appoiment")){
                            Toast.makeText(ViewPrescriptionActivity.this,"No Booking any Appoiment",Toast.LENGTH_LONG).show();
                        }
                        else {
                            String pre_date = jsonObject2.getString("pre_date");
                            String pre_message = jsonObject2.getString("pre_message");
