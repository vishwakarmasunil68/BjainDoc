...
import static com.emobi.bjaindoc.R.id.img_cancel;
...
public class UsersAdapterAppointmentPast extends RecyclerView.Adapter<UsersAdapterAppointmentPast.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView edit;
        public TextView genre,d_dire;
        CircleImageView d_photo;
        ImageView medication;
        public TextView name,d_department,d_address;
...
//            mSnackBarLayout = (CoordinatorLayout) view.findViewById(R.id.coordinator_layout);
    ...
    public UsersAdapterAppointmentPast(List<InfoApps> moviesList, Context ctx, CoordinatorLayout mSnackBarLayout) {
...
//                Log.e("call",moviesList.get(position).getPaid_amount());
        ...
        holder.d_dire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Log.d("list","li");
                    patient_id = TabDoctorPastDate.contactDetails1.get(position).getId();
                    a_date = TabDoctorPastDate.contactDetails1.get(position).getInvo_date();
                    device_token = TabDoctorPastDate.contactDetails1.get(position).getDevice_token();
                    a_time = TabDoctorPastDate.contactDetails1.get(position).getAppotime();
                    Log.e("list","li");
