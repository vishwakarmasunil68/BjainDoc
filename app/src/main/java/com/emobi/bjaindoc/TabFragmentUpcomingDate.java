 ...
 */
public class TabFragmentUpcomingDate extends Fragment {
...
//            Log.d("values",name+"::"+email+"::"+password+"::"+age+"::"+weigt+"::"+height+"::"+descrption);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
//                Toast.makeText(getActivity(),"patient data list",Toast.LENGTH_SHORT).show();
                if (pd != null) {
                    pd.dismiss();
                }
                String date2 = UtilsValidate.getCurrentDate();
                ...
                String reg_mob=jsonObject.getString("reg_mob");
                        ...
                        Detailapp.setPaid_amount(reg_mob);
